...
public class DetalhaFilmeDAO {
	...
	public Filme getFilme(String idFilme){
		...
		try{ 
			...
			while(rs.next()){
				f = new Filme(rs.getInt("idfilme"),rs.getString("titulo"), rs.getString("sinopse"), rs.getString("genero"), rs.getInt("classificacao"), 
	...
	public ArrayList<Ator> getAtorPorFilme(String idFilme){
		...
		try{
			...
			while(rs.next()){
				atores.add(new Ator(rs.getInt("idator"), rs.getInt("idfilme"), rs.getString("nome"), rs.getString("biografia"),rs.getDate("datanasci")));
	...
	public ArrayList<Diretor> getDiretorPorFilme(String idFilme){
		...
		try{
			...
			while(rs.next()){
				diretores.add(new Diretor(rs.getInt("iddiretor"), rs.getInt("idfilme"), rs.getString("nome"), rs.getString("biografia"),rs.getDate("datanasci")));
