...
<title>LokuraFilmes - DetalhaAtor</title>
...
<%}%>
	...
	<div class="container" style="width: 250px;color:black; float: right; padding: 15px; height: auto; width: 150px; text-align: center; word-wrap: break-word; text-overflow: ellipsis;">
			<a href="/LokuraFilmes/editarAtor?idator=<%out.println(a.getIdAtor());%>" style="color:white;">Modificar Ator</a>
		</div>
...
<br>
<a href="/LokuraFilmes/listarAtores"  class="button">Voltar aos atores</a>
<br>
<br>
