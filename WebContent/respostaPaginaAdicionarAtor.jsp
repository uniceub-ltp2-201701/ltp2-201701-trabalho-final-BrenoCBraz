...
<title>LokuraFilmes - PageAdicionarAtor</title>
...
<% HttpSession s = (HttpSession) request.getSession(true);
   ...
   if(!(u==null) && u.getPrivilegio()==1){%>
	...
	<div id="page" class="container">
		<div id="content">
		<div class="title">
		<h2 style="text-align:center;">Adicionar <span class="byline">Ator</span></h2>
		</div>


   
<div id="local">
  <form action="adicionarAtor" style="height:auto" method="post">
